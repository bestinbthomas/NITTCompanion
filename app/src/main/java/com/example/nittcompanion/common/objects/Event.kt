...
data class Event(var name:String = "",
    ...
    val month : String get() = Calendar.getInstance().getCalEnderWithMillis(startDate).getMonthInFormat()
    val date : String get() = Calendar.getInstance().getCalEnderWithMillis(startDate).getDateInFormat()
